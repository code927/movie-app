...
const Login = () => {
    ...
    return (
        <div>
            ...
            <img className='w-[100vw] h-[100vh] bg-cover' src="https://www.geo.tv/assets/uploads/updates/2023-01-03/462603_4381654_updates.jpg" alt="banner" /> 
            </div>
            <form onSubmit={getInputData} className='flex flex-col w-3/12 p-12 my-36 left-0 right-0  mx-auto items-center justify-center absolute rounded-md bg-black opacity-90'>
                ...
                <div className='flex flex-col'>
                    ...
                    <p className='text-white mt-2'>
                        {isLogin ? "New to Netflix?" : "Already have an account?"}<span onClick={loginHandler} className='ml-1 text-blue-900 font-medium cursor-pointer'>{isLogin ? "Signup" : "Login"}</span></p>
                </div>
            </form>
        </div>
    )
